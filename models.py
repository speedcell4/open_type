...
from model_utils import CNN, MultiSimpleDecoder, SelfAttentiveSum, SimpleDecoder, sort_batch_by_length
...
class Model(nn.Module):
    ...
    def define_loss(self, logits, targets, data_type):
        ...
        if data_type == 'wiki':
            ...
            gen_cutoff, fine_cutoff, final_cutoff = constant.ANSWER_NUM_DICT['gen'], constant.ANSWER_NUM_DICT[
                'kb'], None
        loss = 0.0
